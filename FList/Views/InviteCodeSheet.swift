    ...
    var body: some View {
        NavigationStack {
            ...
            .alert(
                ...
                Text("Send the code in a message. The other person pastes it in FList, or scans this QR in the app.")
            }
        }
    }
    ...
    private func inviteContent(for url: URL) -> some View {
        ...
        return List {
            Section {
                ...
                Text("They paste the code in FList, or scan this QR code in the app.")
            }
